...
======
    ...
    for epoch in range(FLAGS.epoch):
        ...
        g, m = sess.run([cram.glimpses, cram.glimpse_condition_correlation])

        # fixme: for debugging
        #
        glimpse_summary = sess.run(cram.temp_summary)
        summary_writer.add_summary(glimpse_summary, counter)
        #
